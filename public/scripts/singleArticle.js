        ...
        data.forEach(obj => {
            if (obj.id == pageId) {
                blogWrapper.insertAdjacentHTML(`beforeend`,
                    ...
                    <p class="font-Dana text-zinc-700 dark:text-gray-100 text-base leading-[2rem] md:text-lg md:leading-[2.5rem] lg:text-xl lg:leading-[3rem] xl:text-2xl xl:leading-[3.5rem] text-justify ">${obj.text}</p> `
                )
            }
        })
    })
