...
let allCardsInfo = [
    {id : 8, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "135,000"},
    {id : 9, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "145,000"},
    {id : 10, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "155,000"},
    {id : 11, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "165,000"},
    {id : 12, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "175,000"},
    {id : 13, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "185,000"},
    {id : 14, src1 : "./img/logo.png", src2 : "./img/logo.png", src3 : "./img/logo.png", src4 : "./img/logo.png", title : "بوردگیم های یوگای کودک", desc : "این بوردگیم ها مخصوص یوگای کودک هستند و شما با استفاده از این بوردگیم ها در کلاس یوگای کودک خود و یا در خانه می توانید کودک خود را سرگرم کنید." , price : "195,000"},
]
